...
def compute_jaccard_distance(target_features, k1=20, k2=6, print_flag=True, search_option=5, use_float16=False):
    end = time.time()
    # if print_flag:
    ...
    mat_type = np.float16 if use_float16 else np.float32  # float32
