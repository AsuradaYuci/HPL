...
def build_losses(config):
    ...
    elif config.LOSS.CLA_LOSS == 'crossentropylabelsmooth':  # 1111
    ...
    # Build pairwise loss
    if config.LOSS.PAIR_LOSS == 'triplet':  # 111111
    ...
    # elif config.LOSS.CLOTHES_CLA_LOSS == 'cosface':  # 1111111
    ...
    # if config.LOSS.CAL == 'cal':  # 11111111
