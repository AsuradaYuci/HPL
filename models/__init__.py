...
def build_model(config, num_identities):
    ...
    # Build classifier
    if config.LOSS.CLA_LOSS in ['crossentropy', 'crossentropylabelsmooth']:  # 'crossentropylabelsmooth' 111
    ...
    return model, identity_classifier